...
public class HomeController implements Initializable {
    ...
    @FXML
    private ChoiceBox<String> mycheckbox;
...
String filename = "accounts.txt";
    ...
    @Override
        ...
        mycheckbox.getItems().addAll("Active","Inactive");
        ...
        mytable.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            ...
            if (newSelection != null) {
                ...
                mycheckbox.setValue(newSelection.getAccountstatus());
            }
        });
    ...
    private boolean createuser(ActionEvent event) {
        ...
        String status = mycheckbox.getValue();
